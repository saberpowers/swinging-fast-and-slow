...
#' @param causal_model a list of fitted GLM models from \code{\link{fit_approach_model}}
...
#' @export
#' 
evaluate_approach <- function(approach, pred_outcome_pitch, causal_model, linear_weight) {
