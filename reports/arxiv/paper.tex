...
\usepackage{amsfonts, amsmath, authblk, float, graphicx, tikz}
...
\begin{document}
  ...
  \label{sec:data}
    ...
    \subsection{Building Blocks}
      ...
      \label{sec:pitch-outcome-model}
        ...
        Table \ref{tab:xgboost-hyperparameters} provides details of the pitch outcome component models. We trained the pitch outcome model using the \texttt{R} package \texttt{predpitchscore} (\cite{powers_predpitchscore_2025}), which relies on the eXtreme Gradient Boosting (XGBoost) algorithm (\cite{chen_xgboost_2016}). Models were trained on MLB regular season pitches from 2022 through 2024 with 5-fold cross-validation for hyperparameter tuning.
  ...
  \section*{Acknowledgments}
    ...
    The authors are grateful to Noah Woodward and Nick Wan for discussions and feedback on early versions of this work.
